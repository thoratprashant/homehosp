...
import { PatientLayoutComponent } from './layouts/landing-layout/patient-layout/patient-layout.component';
import { PatientLandingHeaderTopComponent } from './patient-landing-header-top/patient-landing-header-top.component';
